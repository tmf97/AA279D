% TRANSFORMATIONMATRIX_OSC2MEAN_EQUINOCTIAL computes the transformation matrix 
% from osculating equinoctial orbital elements to mean equinoctial orbital 
% elements, along with the vector of mean equinoctial orbital elements and the 
% difference between true longitude and mean longitude.
% 
%   Inputs:
%     mean_equi - mean equinoctial orbital element vector
% 
%   Outputs:
%     D_J2     - transformation matrix from mean to osculating equinoctial
%                orbital elements
%                D_J2 = I + (-J2*Re^2)*(D_lp+D_sp1+D_sp2)
%     osc_equi - vector of osculating equinoctial orbital elements
%     Psi_Lam  - difference between true longitude and mean longitude

function [D_J2, osc_equi, Psi_Lam] = ...
    transformationmatrix_osc2mean_equinoctial(mean_equi)
